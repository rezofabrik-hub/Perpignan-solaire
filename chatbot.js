...
(function () {
  ...
  function buildWidget() {
    ...
    style.textContent = [
      ...
      '#sb-head-logo{display:flex;align-items:center;flex-shrink:0;text-decoration:none}',
      '#sb-head-logo img{height:44px;width:auto;display:block;filter:brightness(0) invert(1)}',
